...
a=apply_interaction_director(copy.deepcopy(base),{}, {},30.0);b=apply_interaction_director(copy.deepcopy(base),{}, {},30.0)
assert a['interaction_plan_qa']['pass'],a['interaction_plan_qa'];engine=a['interaction_engine'];assert engine['logical_interaction_count']==1,engine;assert engine['physical_action_count']==2,engine
