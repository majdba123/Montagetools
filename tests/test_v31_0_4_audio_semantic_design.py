...
event={'event_id':'S1_HERO','scene_id':'S1','visual_card_id':'C1','physical_id':'P1','semantic_unit_id':'HERO','semantic_scope_id':'S1::HERO','semantic_mapping_confidence':.99,'start_seconds':0.0,'end_seconds':4.0,'preset_entry':{'name':'APPEAR_HIGH_SCALE','duration_seconds':.8,'start_seconds':.56},'identity_key':'CONCEPT::SECURE_PAYMENT'}
motion={'events':[event],
        ...
        'semantic_events':[{'event_id':'SEMANTIC_S1_HERO','anchor_id':'ANCHOR_S1_HERO','anchor_time':1.0,'target_instance_id':'INSTANCE_S1_HERO','event_type':'ENTRY','semantic_role':'PRIMARY','source_authority':'SOURCE_SEMANTIC_CONTINUITY','preset':'APPEAR_HIGH_SCALE','motion_start':0.56,'perceptual_hit':1.0,'resulting_state':'S1','related_instance_ids':[]}],
...
t=titles['events'][0];assert 0.06<=t['y_norm']<=.20 and t['text']=='Secure payment'
