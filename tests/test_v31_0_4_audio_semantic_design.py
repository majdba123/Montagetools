...
motion={'events':[event],'scenes':[{'scene_id':'S1','visual_card_id':'C1'}],'visual_cards':{'cards':[{'card_id':'C1','start_seconds':0.0,'end_seconds':4.0,'source_scene_ids':['S1'],'story_phase_plan':{'phases':[{'phase_id':'P1'},{'phase_id':'P2'}]},'relationship_resolutions':[]}]}}
