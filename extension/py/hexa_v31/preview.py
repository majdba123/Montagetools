...
from .typography import render_text_rgba
from .motion_solver import min_jerk5, s_curve7
from .preset_authority import preset as _preset_def, progress as _preset_progress, scale as _preset_scale, opacity as _preset_opacity
